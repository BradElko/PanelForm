...
namespace CustomForm_Practice_1
{
    public partial class CustomForm : Form
    {
        ...
        bool mouseHuggingTop, mouseHuggingBottom;
        ...
        private void TopPanel_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            //Form Not Touching Top Or Bottom
            if (MovingFormMinimized && scr.Height - (this.Location.Y + this.Height) > 0 && this.Location.Y > 0)
            {
                mouseHuggingTop = false;
                mouseHuggingBottom = false;
                this.Location = new Point(this.Location.X - LastLocation.X + e.X, this.Location.Y - LastLocation.Y + e.Y);
                this.Update();
            }
            //Form Moving From Top
            else if (MovingFormMinimized && this.Location.Y <= 0 && this.Location.Y <= 0 && e.Y > 32)
            {
                mouseHuggingTop = false;
                mouseHuggingBottom = false;
            ...
            {
                mouseHuggingTop = true;
                mouseHuggingBottom = false;
                this.Location = new Point(this.Location.X - LastLocation.X + e.X, 0);
                this.Update();
            }
            //Form Moving From Bottom
            else if (MovingFormMinimized && scr.Height - (this.Location.Y + this.Height) <= 0 && e.Y < 0)
            {
                mouseHuggingTop = false;
                mouseHuggingBottom = false;
                this.Location = new Point(this.Location.X - LastLocation.X + e.X, this.Location.Y - LastLocation.Y + e.Y);
            ...
            //Form Touching Botom
            else if (MovingFormMinimized && scr.Height - (this.Location.Y + this.Height) <= 0)
            {
                mouseHuggingTop = false;
                mouseHuggingBottom = true;
                this.Location = new Point(this.Location.X - LastLocation.X + e.X, scr.Height - this.Height);
                this.Update();
            }
            //Maximized Form Not Touching Top Or Bottom
            if (MovingFormMaximized && scr.Height - (this.Location.Y + this.Height) > 0 && this.Location.Y > 0)
            {
                mouseHuggingTop = false;
                mouseHuggingBottom = false;
                this.Location = new Point(this.Location.X - LastLocation.X + e.X, this.Location.Y - LastLocation.Y + e.Y);
            ...
            //Maximized Form Moving From Top
            else if (MovingFormMaximized && this.Location.Y <= 0 && this.Location.Y <= 0 && e.Y > 32)
            {
                mouseHuggingTop = false;
                mouseHuggingBottom = false;
                this.Location = new Point(this.Location.X - LastLocation.X + e.X,
            ...
            //Maximized Form Moving From Bottom
            else if (MovingFormMaximized && scr.Height - (this.Location.Y + this.Height) <= 0 && e.Y < 0)
            {
                mouseHuggingTop = false;
                mouseHuggingBottom = false;
                this.Location = new Point(this.Location.X - LastLocation.X + e.X, this.Location.Y - LastLocation.Y + e.Y);
            ...
            //Maximized Form Touching Botom
            else if (MovingFormMaximized && scr.Height - (this.Location.Y + this.Height) <= 0)
            {
                mouseHuggingTop = false;
                mouseHuggingBottom = true;
                this.Location = new Point(this.Location.X - LastLocation.X + e.X, scr.Height - this.Height);
